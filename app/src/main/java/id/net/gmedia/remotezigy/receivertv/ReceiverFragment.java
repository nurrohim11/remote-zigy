...
public class ReceiverFragment extends Fragment {
    ...
    private void initUI() {
        ...
        rvListConnection = (RecyclerView) view.findViewById(R.id.rv_list_connection);
    ...
    private void setListConnection(List<CustomItem> listItem){
        ...
        if(listItem != null){
            ...
            final ConnectionListAdapter menuAdapter = new ConnectionListAdapter(getContext(), listItem);
    ...
    private class SocketServerTask extends AsyncTask<JSONObject, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if (success) {
                Toast.makeText(getActivity(), "Connection Done", Toast.LENGTH_SHORT).show();
            } else {
