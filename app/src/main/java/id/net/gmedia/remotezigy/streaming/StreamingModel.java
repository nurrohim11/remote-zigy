...
public class StreamingModel {
    ...
    public StreamingModel(String id, String title, String icon, String url, String kategori, String m_package, String url_playstore, String url_web){
        this.id = id;
        this.title = title;
        this.icon = icon;
        this.url = url;
    ...
    public StreamingModel(String id, String icon){
        this.id = id;
        this.icon = icon;
    }
